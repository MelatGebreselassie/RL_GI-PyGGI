...
# statement type
# class multiline_stmt():
#     def __init__(self, type):
#         self.type = type

# class StmtDeletion(NodeDeletion, multiline_stmt):
#     NODE_TYPE = multiline_stmt

# class StmtReplacement(NodeReplacement, multiline_stmt):
#     NODE_TYPE = multiline_stmt

# class StmtInsertion(NodeInsertion, multiline_stmt):
